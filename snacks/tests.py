...
class SnacksTests(TestCase):
    def setUp(self):
        ...
        Snack.objects.create(name='KitKat', purchaser=purchaser, description="candy bar")
    ...
    def test_list_page_context(self):
        ...
        self.assertEqual(snacks[0].name, "KitKat")
        self.assertEqual(snacks[0].description,"candy bar")
    ...
    def test_detail_page_context(self):
        ...
        self.assertEqual(snack.name, "KitKat")
        self.assertEqual(snack.description,"candy bar")
